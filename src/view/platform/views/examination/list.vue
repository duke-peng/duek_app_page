<template>
    <div>
        <el-form :inline="true">
            ...
            <el-form-item label="题目属性" clearable>
                <el-select v-model="queryData.bigType">
                    <el-option :value="item.value" :label="item.label" v-for="(item, key) in bigType" :key="key"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <el-table :data="data" height="550">
            <el-table-column v-for="(item, index) in column" v-bind="item" :key="index"></el-table-column>
        ...
        <el-pagination :total="total" :page-size="queryData.pageSize" @current-change="current"></el-pagination>
        <el-dialog title="标题" :visible.sync="open">
            ...
            <template slot="footer">
                <el-button type="primary" v-if="openType == 'add'" @click="addok">确定</el-button>
...
<script>
import { getHttp, postHttp } from "@/view/platform/api/http.js";
